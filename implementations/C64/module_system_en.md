...
│     def rotate(): ...              # own                   │
│                                                             │
│   Compile: pyco c64 compile my_game_utils.pyco --module   │
...
| Command | Result | `main()` |
|---------|--------|----------|
| `pyco c64 compile mylib.pyco` | mylib.prg | ✓ Included, runs |
| `pyco c64 compile mylib.pyco --module` | mylib.pm | ✗ Excluded (tree-shaking) |
